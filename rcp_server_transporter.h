...
struct rcp_server_transporter
{
    ...
    void (*sendToAll)(rcp_server_transporter* transporter, const char* data, size_t size, void* excludeId);

    // received callback
    void (*received)(rcp_server* server, const char* data, size_t size, void* client);
